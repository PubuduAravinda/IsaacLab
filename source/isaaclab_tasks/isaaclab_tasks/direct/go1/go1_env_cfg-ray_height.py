...
class Go1FlatEnvCfg(DirectRLEnvCfg):
    ...
    action_scale = 0.5
    action_space = 12
    # Observation: gravity(3) + angular_vel(3) + foot_contacts(4) + joint_pos(12) + joint_vel(12) + height(1) + actions(12) = 47
    ...
    # reward scales
    leg_contact_scale: float = 1.0
    imu_upright_scale: float = 2.0
    height_scale: float = 2.0


@configclass
class Go1RoughEnvCfg(Go1FlatEnvCfg):
    # env - same observation space
    observation_space = 47
